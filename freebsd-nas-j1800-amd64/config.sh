...
install -d -m 755 -o guy -g guy "${DESTDIR}"/home/guy/git || exit 1
install -d -m 755 -o guy -g guy "${DESTDIR}"/home/guy/hg || exit 1
install -d -m 755 -o guy -g guy "${DESTDIR}"/home/guy/lan_web || exit 1
...
install -d -m 755 -o root -g wheel "${DESTDIR}"/usr/ports || exit 1
...
install -d -m 755 -o guy -g guy "${DESTDIR}"/home/guy/config || exit 1
install -c -m 644 -o guy -g guy tree/home/guy/config/gitweb.conf "${DESTDIR}"/home/guy/config/gitweb.conf || exit 1
...
install -c -m 644 -o root -g wheel tree/etc/local/nginx/fastcgi_params "${DESTDIR}"/etc/local/nginx/fastcgi_params || exit 1
