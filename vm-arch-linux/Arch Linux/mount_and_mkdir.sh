...
install -d -m 1777 -o root -g users /mnt/home/public || exit 1
install -d -m 1777 -o root -g users /mnt/home/shares || exit 1
...
mount -t nfs -orw packages:/packages/archlinux /mnt/var/cache/pacman || exit 1
