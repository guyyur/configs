...
install -d -m 700 -o guy -g guy /mnt/var/xdg-cache/guy/thumbnails || exit 1
...
install -d -m 755 -o guy -g guy /mnt/home/guy/modifications || exit 1
...
install -d -m 1777 -o root -g wheel /mnt/home/public || exit 1
install -d -m 1777 -o root -g wheel /mnt/home/shares || exit 1
install -d -m 0700 -o guy -g guy /mnt/home/shares/guy || exit 1

mount -o noatime /dev/"${disk4}"p1 /mnt/chroots || exit 1

mount -o noatime /dev/"${disk5}"p1 /mnt/export/ports || exit 1
install -d -m 755 -o root -g wheel /mnt/export/ports/.portsnap || exit 1
